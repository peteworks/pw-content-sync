...
Sync page content and ACF fields from a source WordPress site to the current site via REST API.
...
2. **Release an update:**
   - Bump the `Version` in the plugin header in `sf-content-sync.php` (e.g. `1.0.0` → `1.0.1`).
